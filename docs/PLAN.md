...
| Area             | Task                               | What you should be able to do                                            |
| ---------------- | ---------------------------------- | ------------------------------------------------------------------------ |
| Terraform basics | Create an EC2 instance             | Write provider, resource, security group, key pair, output public IP     |
| Terraform basics | Terminate EC2 using Terraform      | Remove resource from code and run `terraform destroy` or `apply` cleanly |
| Terraform basics | Create S3 bucket                   | Add versioning, encryption, public access block                          |
